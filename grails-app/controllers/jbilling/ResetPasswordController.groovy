...
class ResetPasswordController {
    ...
    def captcha (){
        ...
        if (result) {
            ...
            boolean useEmail = doUseEmail(params.int('companyId'))
            ...
            if (useEmail){
                user = new UserBL().findUsersByEmail(params.email, params.int('companyId')).get(0)
            }else{
                user = new UserDAS().findByUserName(params.userName, params.int('companyId'))
            }
