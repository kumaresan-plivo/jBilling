...
class EdiStatusController {
    ...
    def list (){
       ...
       def filters = filterService.getFilters(FilterType.EDI_FILE, params)
        ...
        if (params.applyFilter || params.partial) {
            ...
            render view: 'list', model: [selected: selected, ediStatusList: ediFileStatusDTOList,filters: filters]
        }
    }
    ...
    def save (){
        ...
        ediFileStatusWS.setCreateDatetime(new Date())
        if (params.int("id")){
