...
class RouteBasedRateCardController {
    ...
    def list (){
       ...
       List<AccountTypeDTO> accountTypeDTOList=AccountTypeDTO.createCriteria().list(max: params.max, offset: params.offset) {
        ...
        [cards: cards, selected: selected, matchingFields: matchingFields, accountTypeDTOList: accountTypeDTOList, showEditTemplate: params.showEditTemplate, availMatchingFields:chainModel ? chainModel?.selectMatchingField : null]
    ...
    def edit (){
        ...
        if (params.id && routeRateCard == null) {
    ...
    def csv (){
        def routeRateCard = params.id ? RouteRateCardDTO.get(params.int('id')) : null
...
//                save or update
    ...
    def saveMatchingField (){
        ...
        try {
            ...
            viewUtils.resolveException(flash,session.locale,e)
            def routeRateCard = RouteRateCardDTO.get(routeRateCardId)
            def selectMatchingField =new RouteBasedRateCardBL().getUnusedRouteRateCardColumns(routeRateCard?.tableName, routeRateCardId)
            chain(controller: 'routeBasedRateCard', action: 'list',
