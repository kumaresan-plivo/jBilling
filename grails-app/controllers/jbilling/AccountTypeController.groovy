...
class AccountTypeController {
    ...
    def listPrices () {
        ...
        if (params.id) {
            ...
            render view: 'accountTypePrices', model: [
                    accountType: accountType,
                    prices: prices,
                    products: products,
                    company: company,
    ...
    def filterProducts (){
        def company = CompanyDTO.get(session['company_id'])
        def itemTypes = getProductCategories()
        def accountType = params.typeId ? AccountTypeDTO.get(params.int('typeId')) : null
        ...
        def products =  productService.getFilteredProducts(company, null, params, accountType, true, true)
    ...
    def allProductPrices (){
        ...
        render template: 'prices', model: [ prices: prices, accountTypeId: params.accountTypeId ]
    }
    ...
    def saveAccountTypePrice () {
        ...
        chain controller: 'accountType', action: 'listPrices', params: [ id: accountType.id ]
    }
    ...
    def deleteAccountTypePrice (){
        ...
        def prices = new AccountTypePriceBL(params.int('accountTypeId')).getAccountTypePrices()
        render template: 'prices', model: [ prices: prices, accountTypeId: params.accountTypeId ]
    }
    ...
    def editAITFlow ={
        ...
        updateAITMetaField {
            action {
                ...
                conversation.ait = ait
                def unSavedMetafields = conversation.unSavedMetafields.findAll{!ait.metaFields.id.contains(it.id)}+ait.metaFields.findAll { StringUtils.trimToNull(it.name) != null } ?: []
