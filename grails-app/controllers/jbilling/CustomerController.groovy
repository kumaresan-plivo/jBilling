...
//                                            addToCriteria(Restrictions.eq("fieldValue.value", fieldValue.getValue()))
    ...
    def list (){
        ...
        def userIsAllowed = securityValidator.validateCustomerAgentRelationship(session['user_id'], selected, Validator.Type.VIEW)
...
/**
    ...
    def show () {
        ...
        FlowHelper.display(this, true, [template: params.template ?: 'show',
                                        model   : [selected: user, customerEnrollment:customerEnrollment, customerNotes: retrieveCustomerNotes()] + userData])
    }
