...
class PlanBuilderController {
    ...
    def editFlow = {//do not change this to method. Webflow will not be able to find it.
        ...
        initialize {
            action {
                ...
                availableFields = retrieveAvailableMetaFields(product.entityId?product.entityId:session['company_id'])
        ...
        addPrice {
            action {
                ...
                conversation.priceModelData = productService.getFilteredProducts(flow.company, ItemBL.getItemDTOEx(product), params, null, false, false)
        ...
        updatePlan {
            action {
                ...
                Date newStartDate = new Date().parse(message(code: 'date.format'), params.startDate)
                Date originalStartDate = new Date().parse(message(code: 'date.format'), params.originalStartDate)
                ...
                bindMetaFields(conversation.plan, params, isRoot)
	...
	def bindMetaFields(plan, params, isRoot) {
		def fieldsArray
