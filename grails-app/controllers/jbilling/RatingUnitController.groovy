...
class RatingUnitController {
    ...
    def getList(params) {
        ...
        if (params.applyFilter || params.partial) {
            ...
            if(chainModel){
                def cp = chainModel
                render view: 'list', model:[selected: ratingUnit, ratingUnits: ratingUnits]+chainModel
            }
            else
                render view: 'list', model:[ratingUnits: ratingUnits, selected: ratingUnit]
        }
    }
    ...
    def save (){
        ...
        try {
            ...
            chain action: 'list', model:[ratingUnitWs:ws]
            return
        } catch (Exception e) {
