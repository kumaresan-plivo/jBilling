...
<div class="column-hold">
        ...
        <div class="sub-box">
            <table class="dataTable" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="value">
                        <g:formatDate date="${selected?.lastUpdateDate}" formatName="date.timeSecsAMPM.format"/>
                    </td>
                </tr>
                <tr>
    ...
    <div class="table-box">
        ...
        <div class="row">
            <g:link class="submit show" controller="provisioning" action="showRequests" params="[selectedId: selected?.id]">
