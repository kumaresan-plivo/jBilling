...
<%@ page import="com.sapienter.jbilling.server.item.ItemDependencyType; com.sapienter.jbilling.server.pricing.db.PriceModelStrategy; com.sapienter.jbilling.server.util.Util"%>
...
<div class="column-hold">
	...
	<div class="box">
        <div class="sub-box">
            ...
            <g:set var="price" value="${ selectedProduct.getPrice(new Date(), session['company_id'])}"/>
            ...
            <g:if test="${selectedProduct.defaultPrices}">
	            <table class="dataTable" cellspacing="0" cellpadding="0" width="100%">
	                <tbody>
	                    <g:render template="/plan/priceModel" model="[model: selectedProduct.getPrice(new Date(), session['company_id'] as Integer)]"/>
	                </tbody>
	            </table>
            </g:if>
    ...
    <g:if test="${!selectedProduct.deleted}">
        ...
        <sec:ifAllGranted roles="ASSET_130">
            <g:if test="${assetManagementPossible && (selectedProduct.assetManagementEnabled > 0)}">
