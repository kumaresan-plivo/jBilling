...
<div class="column-hold">
    ...
    <g:if test="${!asset.deleted}">
        ...
        <g:if test="${asset.isReserved()}">
            <sec:ifAllGranted roles="ASSET_133">
        ...
        <g:link class="submit show" controller="provisioning" action="showCommands" params="[type: 'ASSET', typeId: asset.id]">
