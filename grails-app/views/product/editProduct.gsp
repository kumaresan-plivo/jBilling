...
<%@ page import="com.sapienter.jbilling.server.pricing.db.RouteDAS; com.sapienter.jbilling.server.user.db.CompanyDTO; com.sapienter.jbilling.server.metafields.MetaFieldBL; com.sapienter.jbilling.server.metafields.DataType; com.sapienter.jbilling.server.metafields.EntityType; com.sapienter.jbilling.server.metafields.db.MetaFieldDAS; com.sapienter.jbilling.server.metafields.MetaFieldWS; com.sapienter.jbilling.common.CommonConstants; com.sapienter.jbilling.server.util.db.EnumerationDTO; com.sapienter.jbilling.server.util.db.CurrencyDTO; com.sapienter.jbilling.server.util.db.LanguageDTO; com.sapienter.jbilling.server.item.db.ItemTypeDTO" %>
            ...
            <fieldset>
                ...
                <div id="pricing" class="box-cards box-cards-open">
                    ...
                    <div id="priceBox" class="box-card-hold">
                        ...
                        <g:render template="/priceModel/model" model="[
                                product: product, models: defaultPrices,
                                startDate: startDate, priceModelData: priceModelData]"/>
                    </div>
                </div>
