                ...
                <div class="sub-box">
                    <table class="dataTable" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td class="value"><g:formatDate date="${transferredPayment?.createDatetime}" formatName="date.timeSecsAMPM.format"/></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <g:if test="${!selected.deleted}">
        ...
        <div class="row">
            <g:link action="emailNotify" id="${selected.id}" class="submit email">
                ...
                <g:link class="submit show" controller="provisioning" action="showCommands" params="[type: 'PAYMENT', typeId: selected.id ]">
