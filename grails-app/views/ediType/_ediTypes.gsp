...
<div class="table-box">
    ...
    <table id="tbl-edi-types" cellspacing="0" cellpadding="0">
        <thead>
        <tr>
            <th><g:remoteSort action="list" sort="name" update="column1"><g:message
                    code="edi.type.name"/></g:remoteSort></th>
            <th><g:message code="edi.type.path"/></th>
            <th><g:message code="edi.type.entity"/></th>
        </tr>
        </thead>
...
<div class="pager-box">
    ...
    <div class="row">
        <util:remotePaginate action="list" total="${ediTypes?.totalCount ?: 0}" update="column1"
                             params="[partial: true]"/>
    </div>
</div>
...
<div class="btn-box">
    <sec:ifAllGranted roles="EDI_921">
        <g:remoteLink action='edit' class="submit add" update="column2"><span><g:message
