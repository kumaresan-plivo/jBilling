                ...
                <fieldset>
                    <div class="form-columns">
                        ...
                        <g:applyLayout name="form/input">
                            <content tag="label"><g:message code="edi.type.name"/></content>
                        ...
                        <g:applyLayout name="form/input">
                            <content tag="label"><g:message code="bean.EDITypeWS.ediSuffix"/></content>
                            ...
                            <g:if test="${ediType?.ediStatuses}">
                                <g:each in="${ediType?.ediStatuses}" var="status" status="i">
                                    <g:applyLayout name="form/description">
                                        ...
                                        <div class="actionDiv ">
                                             <a class="deleteStatus"><img src="${resource(dir:'images', file:'cross.png')}" alt="remove"/></a>
                                         </div>
