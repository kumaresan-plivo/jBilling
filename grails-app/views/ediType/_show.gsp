    ...
    <div class="btn-box">
        <div class="row">
            <sec:ifAllGranted roles="EDI_921">
                <g:remoteLink action='edit' class="submit edit" update="column2" params="[id:ediType?.id]"><span><g:message code="button.edit"/></span></g:remoteLink>
            </sec:ifAllGranted>
                <sec:ifAllGranted roles="EDI_920">
                    ...
                    <g:link controller="ediType" action="download" params="[id:ediType?.id]" class="submit save"><span><g:message code="edi.type.button.download"/></span></g:link>
