...
<div id="field-setup">
    ...
    <table>
        <thead>
        <tr>
            <th><g:message code="invoiceTemplate.fieldSetup.table.show"/></th>
        ...
        <tr>
            ...
            <td><select
                    data-bind="click: $root.setTitleName, options: $root.fields, optionsText: 'description', value: field"></select>
            </td>
