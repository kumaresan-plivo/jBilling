    ...
    var alpacaDefault = {
                            ...
                            options: {
                                fields: {
                                    ...
                                    id: { type: "hidden"},
                                    kind: { type: "hidden"},
                                    expr: { type: "textarea", helper: "<a href='javascript:showListTemplateParameters()'>Available parameters</a>"},
                    ...
                    if (appendable != null) {
                        ...
                        for (var i = 0; i < allowedChildren.length; i++) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(cif_schemas, allowedChild)) {
                                $("<a href='#' class='submit add new-templateelement-button'>").
...
<div class="form-edit">
    ...
    <div class="heading">
        <div id="paging" style="float: right">
            <a id="previous-page" class="prev" href="#" style="display: none;"
               title="${message(code: 'invoiceTemplate.previousPage.label')}">&lt;</a>
            <span id="page-number">1</span>
            <a id="next-page" class="next" href="#" title="${message(code: 'invoiceTemplate.nextPage.label')}">&gt;</a>
        </div>
        <strong>
