        ...
        <div class="btn-box">
            <div class="row">
                <sec:ifAllGranted roles="INVOICE_TEMPLATES_1802">
                    <g:remoteLink action='create' class="submit add" before="register(this);"
                                  onSuccess="render(data, next);">
                        <span><g:message code="button.create"/></span>
                    </g:remoteLink>

                    <a id="upload-new-template" class="submit2 load"><span><g:message code="button.upload"/></span></a>
                                            ...
                                            $.ajax({
                                                ...
                                                statusCode: {
                                                    500: function(jqXHR,textStatus, errorThrown) {
                                                        $createTemplateForm.find('#invoice-template-error-messages li').html(jqXHR.responseText);
