...
<div class="pager-box">
    ...
    <div class="row">
        <util:remotePaginate controller="customerEnrollment" action="list" total="${customerEnrollments?.totalCount ?: 0}" update="column1" params="[partial:true]"/>
    </div>
</div>

<sec:ifAllGranted roles="CUSTOMER_ENROLLMENT_911">
<div class="btn-box">
    <g:link action='edit' class="submit add"><span><g:message code="customer.enrollment.button.create"/></span></g:link>
