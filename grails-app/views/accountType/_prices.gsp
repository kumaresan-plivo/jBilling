        ...
        <div class="sub-box">
            <table class="dataTable" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    ...
                    <g:render template="/plan/priceModel" model="[model: product.getPrice(new Date(),session['company_id'] as Integer)]"/>
                </tbody>
            </table>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <g:if test="${!price.plan}">
                                ...
                                <g:link action="editAccountTypePrice" id="${price.id}" params="[accountTypeId: accountType?.id ?: params.accountTypeId, itemId: price.item.id]">
                                %{--<g:remoteLink action="editAccountTypePrice" id="${price.id}" params="[accountTypeId: accountType?.id ?: params.accountTypeId, itemId: price.item.id]">--}%
                        ...
                        <td class="right">
                            <g:if test="${!price.plan}">
                                ...
                                <g:remoteLink action="deleteAccountTypePrice" id="${price.id}" params="[accountTypeId: accountType?.id ?: params.accountTypeId, itemId: price.item.id]" update="prices-column">
