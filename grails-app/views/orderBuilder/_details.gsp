...
<div id="details-box">
    ...
    <g:formRemote name="order-details-form" url="[action: 'edit']" update="ui-tabs-review" method="GET">
        ...
        <div class="form-columns">
			...
			<div id="feeDiv">
            <g:applyLayout name="form/input">
            	<content tag="label"><g:message code="order.label.cancellation.fee"/> <span id="mandatory-meta-field">*</span></content></content>
            ...
            <g:applyLayout name="form/input">
            	<content tag="label"><g:message code="order.label.cancellation.fee.percentage"/> <span id="mandatory-meta-field">*</span></content></content>
