		...
		<table id="invoices" cellspacing="0" cellpadding="0">
			<thead>
                <tr>
                    ...
                    <th class="large">
                        <g:remoteSort action="list" sort="contact.firstName, contact.lastName, contact.organizationName, baseUser.userName" alias="[contact: 'baseUser.contact']" update="column1" fetch="1">
