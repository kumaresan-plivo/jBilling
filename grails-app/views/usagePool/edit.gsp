            ...
            <fieldset>
                ...
                <div class="form-columns">
                    <div class="column">
                        ...
                        <g:applyLayout name="form/select">
                            <content tag="label"><g:message code="usagePool.cyclePeriod"/><span id="mandatory-meta-field">*</span></content>
                ...
                <div class="buttons">
                    <ul>
                        <li>
                            <a onclick="$('#usage-pool-edit-form').submit()" class="submit save"><span><g:message code="button.save"/></span></a>
                        </li>
                        <li>
