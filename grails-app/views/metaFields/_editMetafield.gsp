...
<g:set var="dependentMetaFields" value="${metaField.dependentMetaFields != null ? org.apache.commons.lang.ArrayUtils.nullToEmpty(metaField.dependentMetaFields) : ''}" />
...
<div id="metaFieldModel${metaFieldIdx}" class="form-columns">
    ...
    <div class="column">
        <div id="dependency" >
       <g:set var="totalDependency" value="${metaField.dependentMetaFields ? metaField.dependentMetaFields.size():0}"/>
                <g:applyLayout name="form/checkbox">
                    <content tag="label"><g:message code="button.show.dependencies"/></content>
                    <content tag="label.for">dependencyCheck</content>
                    <g:checkBox class="cb checkbox" id="mandatoryCheck${metaFieldIdx}" name="dependency-checkbox" checked="${totalDependency>0}"/>
                </g:applyLayout>
    ...
    <div class="column">
        <div class="help">
            <g:applyLayout name="form/checkbox">
                ...
                <g:checkBox class="cb checkbox" id="helpCheck${metaFieldIdx}" name="help-checkbox" checked="${metaField?.helpContentURL?true:false}"/>
            </g:applyLayout>
            <div id="help-contents${metaFieldIdx}" style="display: none">
                <g:applyLayout name="form/input">
                    ...
                    <g:textField class="field" name="metaField${metaFieldIdx}.helpContentURL" value="${metaField?.helpContentURL}"/>
                </g:applyLayout>
                <g:applyLayout name="form/input">
                    ...
                    <g:textField class="field" name="metaField${metaFieldIdx}.helpDescription" value="${metaField?.helpDescription}"/>
                </g:applyLayout>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
       <g:if test="${totalDependency==0}">
        ...
        $("#mandatoryCheck${metaFieldIdx}").on("change", function(e){
            if($(this).is(":checked")) {
