            ...
            <table class="dataTable" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="value"><span><g:formatDate format="MM/dd/yyyy" date="${userCode.validFrom}"/></span></td>
                    </tr>
                    <tr>
                        <td><g:message code="userCode.detail.validTo"/></td>
                        <td class="value"><span><g:formatDate format="MM/dd/yyyy" date="${userCode.validTo}"/></span></td>
                    </tr>
