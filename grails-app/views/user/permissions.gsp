                            ...
                            <g:each var="permission" status="i" in="${permissionType.permissions}">
                                ...
                                <g:if test="${i % 2 == 0}">
                                    ...
                                    %{
                                        ...
                                        def isSystemAdminPermissionEven = (permission.id in sysAdminPermission && !(permission.id in permissions.id)) ||
                                            !(permission.id in permissions.id);
                                    }%
                        ...
                        <div class="column">
                            <g:each var="permission" status="i" in="${permissionType.permissions}">
                                ...
                                <g:if test="${i % 2 == 1}">
                                    ...
                                    %{
                                        permission.initializeAuthority();
                                        def isSystemAdminPermissionOdd = (permission.id in sysAdminPermission && !(permission.id in permissions.id)) ||
                                                !(permission.id in permissions.id);
                                    }%
