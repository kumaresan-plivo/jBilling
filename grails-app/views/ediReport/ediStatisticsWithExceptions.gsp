                        ...
                        <div id="priceBox" class="box-card-hold">
                            <div class="form-columns">
                                <g:applyLayout name="form/date">
                                    ...
                                    <g:textField class="field" name="startDate" value="${formatDate(date: params?.startDate ? new Date(params?.startDate) : null, formatName: 'datepicker.format')}" onblur="validateDate(this)"/>
                                </g:applyLayout>
                                <g:applyLayout name="form/date">
                                    <content tag="label">To</content>
                                    <content tag="label.for">endDate</content>
                                    <g:textField class="field" name="endDate" value="${formatDate(date: params?.endDate ? new Date(params?.endDate) : null, formatName: 'datepicker.format')}" onblur="validateDate(this)"/>
                                </g:applyLayout>
