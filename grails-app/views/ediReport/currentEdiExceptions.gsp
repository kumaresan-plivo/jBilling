...
<%@ page import="com.sapienter.jbilling.server.ediTransaction.EDIFileBL; com.sapienter.jbilling.common.CommonConstants" %>
...
<html>
    ...
    <div class="table-area">
        ...
        <div >
            <g:paginate controller="ediReport" action="currentEdiExceptions" total="${ediFilesTotalCount}" />
        </div>
    </body>
</html>