...
<div class="table-box" id="ediStatuses">
    <table id="orderStatuses" cellspacing="0" cellpadding="0">
        <thead>
        <tr>
            <th class="tiny"><g:remoteSort action="list" sort="id" searchParams="[typeId:params.typeId]" update="ediStatuses"><g:message code="ediStatus.id"/></g:remoteSort></th>
            <th class="large"><g:remoteSort action="list" sort="name" searchParams="[typeId:params.typeId]" update="ediStatuses"> <g:message code="ediStatus.name"/></g:remoteSort></th>
    ...
    <div class="pager-box">
        ...
        <div class="row">
            <util:remotePaginate  action="list" total="${ediStatusList?.totalCount ?: 0}" update="ediStatuses" params="[partial:true,  action:'list', typeId:params.typeId]"/>
        </div>
    </div>
</div>
