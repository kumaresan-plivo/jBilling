                ...
                <div id="customerUsagePools" class="box-cards">
                    ...
                    <div class="box-card-hold">
                        ...
                        <table cellpadding="0" cellspacing="0" class="innerTable">
                            <thead class="innerHeader">
                            <tr>
                                <th style="text-align:center;width:5%;"><g:message code="customerUsagePools.label.id"/></th>
                                ...
                                <th style="text-align:center;width:6%;"><g:message code="customerUsagePools.label.fup.status"/></th>
                                ...
                                <th style="text-align:center;width:18%;"><g:message code="customerUsagePools.label.cycle.end.date"/></th>
                                <th style="text-align:center;width:13%;"><g:message code="customerUsagePools.label.cycle.period"/></th>
                                <th style="text-align:center;width:11%;"><g:message code="customerUsagePools.label.reset.value"/></th>
                            </tr>
                            </thead>
                            <tbody>
                                ...
                                <g:each var="customerusagePool" in="${customerusagePools}">
                                    <tr>
                                        ...
                                        <td class="innerContent" style="text-align:right;width:11%;padding-right: 3%;">
                                             <g:link controller="usagePool" action="list" id="${customerusagePool.usagePool.id}">${customerusagePool.usagePool.id}</g:link>
                                        </td>
                                        ...
                                        <td class="innerContent" style="text-align:center;width:6%;">
                                            <g:if test="${customerusagePool.cycleEndDate.compareTo(new Date()) >= 0}">
                                                 <g:message code="customerUsagePools.fup.status.active"/>
                                             </g:if>
                                             <g:else>
                                             	<span class="fpu-status">
                                             	<g:message code="customerUsagePools.fup.status.expired"/>
                                             </g:else>
                                        </td>
            ...
            <div class="box-cards" align="right">
                <g:uploadForm name="configurationForm" action="uploadConfiguration">
                    <table>
                        <tr>
                            <td>
                                <g:field name="configurationFile" type="file" />
                                <g:hiddenField name="id" value="${user.id}"/>
                            </td>
                            <td>
                                <g:submitButton name="configurationFile" value="Upload" class="submit apply"/>
                            </td>
                        </tr>
                    </table>
                </g:uploadForm>
