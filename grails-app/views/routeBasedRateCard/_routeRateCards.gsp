...
<div class="pager-box">
    ...
    <div class="row">
        <util:remotePaginate controller="routeBasedRateCard"
                             action="list"
...
<div class="btn-box buttons" >
        <ul>
            <li>
                <g:remoteLink action='edit' class="submit add" params="[partial: true]" before="register(this);" onSuccess="render(data, next);">
