...
<div class="column-hold">
    ...
    <div class="box">
        ...
        <div class="btn-box buttons">
            <ul>
                <li>
                    <g:remoteLink action="edit" id="${selected.id}" class="submit" before="register(this);" onSuccess="render(data, second);" params="[partial: true]">
                        <span><g:message code="button.edit"/></span>
                    </g:remoteLink>
                </li>
                <li>
                    <g:remoteLink action="test" update="update" class="submit add" params="[routeRateCardId:selected?.id]">
