...
<div class="column-hold">
    ...
    <div class="box">
          ...
          <fieldset>
            <div class="form-columns">
                ...
                <g:applyLayout name="form/select">
                    ...
                    <content tag="label.for">ratingUnit</content>
                ...
                <g:applyLayout name="form/text">
                    ...
                    <input type="file" name="routeRates"/>
                </g:applyLayout>
        ...
        <div class="btn-box buttons">
            <ul>
                <li><a class="submit save" onclick="$('#route-based-rate-card-form').submit();"><span><g:message code="button.save"/></span></a></li>
