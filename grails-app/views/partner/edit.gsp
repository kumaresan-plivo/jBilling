        ...
        <a id="add-${valueIdx}"
           onclick="addCommissionValue()">
            <img src="${resource(dir: 'images', file: 'add.png')}" alt="remove" class="toolTipElement"
                 title="${message(code: 'partner.commission.value.add.tooltip.message')}"/>
        </a>
    </g:applyLayout>
</div>
</div>
