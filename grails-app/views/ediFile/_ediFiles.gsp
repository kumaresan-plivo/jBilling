...
<div class="table-box" id="ediFiles">
    ...
    <table id="tbl-mediation-config" cellspacing="0" cellpadding="0">
        <thead>
        <tr>
            <th><g:remoteSort action="list"  searchParams="[typeId:params.typeId, enrollmentId:params.enrollmentId]" sort="name" update="ediFiles"><g:message code="edi.file.name"/></g:remoteSort></th>
            ...
            <th><g:remoteSort action="list" searchParams="[typeId:params.typeId, enrollmentId:params.enrollmentId]"  sort="type" update="ediFiles"><g:message code="edi.file.transaction.type"/></g:remoteSort></th>
        </tr>
        </thead>
    ...
    <div class="pager-box">
        ...
        <div class="row">
            <util:remotePaginate  action="list" total="${ediFiles?.totalCount ?: 0}" update="ediFiles" params="[partial:true,  action:'list', typeId: params.typeId, enrollmentId:params.enrollmentId]"/>
        </div>
    </div>
