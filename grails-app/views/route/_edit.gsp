...
<div class="column-hold">
                ...
                <fieldset>
                    <div class="form-columns">
                        ...
                        <g:applyLayout name="form/text">
                            ...
                            <a href="${resource(dir:'examples', file:'example_route.csv')}">example_route.csv</a>
                        </g:applyLayout>
                    </div>
                </fieldset>
            </div>
    ...
    <div class="btn-box buttons">
        <ul>
            <li><a class="submit save" onclick="$('#route-form').submit();"><span><g:message code="button.save"/></span></a></li>
            <g:if test="${!isNew}">
                <li>
