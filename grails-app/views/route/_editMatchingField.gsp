...
<%@ page import="com.sapienter.jbilling.server.pricing.cache.MatchingFieldType; com.sapienter.jbilling.server.pricing.db.RouteDTO; com.sapienter.jbilling.server.user.Required; com.sapienter.jbilling.server.pricing.cache.MatchType; com.sapienter.jbilling.server.pricing.RouteBL" %>
...
<div id="editMatchingFieldForm">
    ...
    <div class="box">
                    ...
                    <fieldset>
                        <div class="form-columns">
                            <div class="column single">
                                ...
                                <g:hiddenField name="routeRateCardId" value="${routeRateCard?.id ?: selected?.id}"/>
                                ...
                                <g:applyLayout name="form/select">
                                    ...
                                    <g:select name="required" from="${Required.values()}"
                                              optionKey="id" optionValue="name" value="${Required.values().find{val-> val.id == matchingField?.required}?.name}" />
                                </g:applyLayout>
                                <g:applyLayout name="form/select">
                                    <content tag="label"><g:message code="bean.MatchingFieldWS.type"/></content>
                                    <content tag="label.for">type</content>
                                    <g:select name="type" from="${MatchingFieldType.values()}" value="${matchingField?.type? MatchingFieldType.valueOf(matchingField?.type) : ''}"/>
                                </g:applyLayout>
                                <g:applyLayout name="form/select">
                                    <content tag="label"><g:message code="bean.MatchingFieldWS.matchingField"/></content>
                                    <content tag="label.for">matchingField</content>
                                    <g:select name="matchingField" from="${availMatchingFields}" value="${matchingField?.matchingField}"/>
                                </g:applyLayout>
                            </div>
                        </div>
                    </fieldset>
        ...
        <div class="btn-box buttons">
            <div class="row">
                <a class="submit save" onclick="$('#save-matching-field-form').submit();">
