...
<div id="${filter.name}">
    ...
    <div class="slide">
        <fieldset>
            <div class="input-row">
                <div class="input-bg">
                    <a href="#" onclick="$('#filters\\.${filter.name}\\.startDate').datepicker('show')"></a>
                    <g:textField class="date-text" name="filters.${filter.name}.startDateValue" value="${formatDate(date: filter.startDateValue, formatName: 'datepicker.format')}" onblur="validateDate(this)"/>
                </div>
            ...
            <div class="input-row">
                <div class="input-bg">
                    ...
                    <g:textField class="date-text" name="filters.${filter.name}.endDateValue" value="${formatDate(date:filter.endDateValue, formatName: 'datepicker.format')}" onblur="validateDate(this)"/>
                </div>
