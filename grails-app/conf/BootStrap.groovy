...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        // [2016-03-10 igor.poteryaev@jbilling.com] Ugly dependency initialization. Added as part of fix for: https://appdirect.jira.com/browse/JB-313
        def applicationContext = grailsApplication.mainContext
        applicationContext.getBean("jbillingUserService").userService = applicationContext.getBean("userService")
