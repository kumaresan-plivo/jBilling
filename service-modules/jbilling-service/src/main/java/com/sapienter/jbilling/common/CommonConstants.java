...
public interface CommonConstants {
    ...
    public static String SUPPORT_LEAD_USERNAME = "support.lead.username";
    public static String SUPPORT_LEAD_EMAIL = "support.lead.email";
    public static String  SUPPORT_USERS_NAMES_REGEX = "support(?:\\d*\\.)?\\d.user";
