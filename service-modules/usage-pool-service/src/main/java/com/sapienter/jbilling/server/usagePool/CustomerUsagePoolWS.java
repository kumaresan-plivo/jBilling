...
public class CustomerUsagePoolWS implements WSSecured, Serializable {
	...
	public String toString() {
		return "CustomerUsagePoolWS [id=" + id + ", customerId=" + customerId + ", userId=" + userId
				+ ", usagePoolId=" + usagePoolId + ", planId=" + planId + ", quantity=" + quantity
				+ ", cycleEndDate=" + cycleEndDate + ", versionNum=" + versionNum + "]";
	}
