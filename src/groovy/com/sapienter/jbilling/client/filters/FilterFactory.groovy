...
class FilterFactory {
    ...
    static baseFilters = ([
        ...
        ORDER: [
			...
			new Filter(type: FilterType.ORDER, constraintType: FilterConstraint.LIKE, field: 'tariff', template: 'order/tariff', visible: true),
        ],
        PRODUCT: [
        ...
        PROVISIONING_CMD: [
            new Filter(type: FilterType.PROVISIONING_CMD, constraintType: FilterConstraint.DATE_BETWEEN, field: 'provisioning.create_date', template: 'date', visible: true),
            new Filter(type: FilterType.PROVISIONING_CMD, constraintType: FilterConstraint.STATUS, field: 'provisioning.command_status', template: 'provisioning/status_cmd', visible: true),
            new Filter(type: FilterType.PROVISIONING_CMD, constraintType: FilterConstraint.STATUS, field: 'provisioning.command_type', template: 'provisioning/type', visible: true),
            new Filter(type: FilterType.PROVISIONING_CMD, constraintType: FilterConstraint.EQ, field: 'provisioning.type_identifier', template: 'value', visible: true),
        ],
        PROVISIONING_REQ: [
