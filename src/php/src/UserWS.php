...
class UserWS {
      ...
      var $accountTypeId;                   // Account Type of the user. See Appendix A for acceptable values.
      var $userName;                        // Identifies the user during login
      var $id;                              // A unique number that identifies the customer
      ...
      /**
       * Lists any meta field values for this user. See the "jBilling User Guide" for more
       * information on meta fields.
       * 
       * @var MetaFieldValueWS[]
       */
      public $metaFields;
	  ...
	  /**
	   * Sets the id property of the UserWS object
	   * 
	   * @access public
	   * @param Integer $id A unique number that identifies the customer
	   * @return void
	  ...
	  public function setId( $id ) {
          ...
          /**
	   * Sets the accountTypeId property of the UserWS object
	   * 
	   * @access public
	   * @param Integer $accountTypeId Account type of the user. See Appendix A for acceptable values.
	   * @return void
	   */
	  ...
	  /**
	   * Gets the id property of the UserWS object
	   * 
	   * @access public
	   * @return Integer A unique number that identifies the customer
	   */
	  public function getId() {
          ...
          /**
	   * Gets the accountTypeId property of the UserWS object
	   * 
	   * @access public
	   * @return Integer Account Type of the user. See Appendix A for acceptable values.
	   */
	  ...
	  public function setUserIdBlackListed( $value ) {
          ...
          public function setMetaFields( $value ) {
