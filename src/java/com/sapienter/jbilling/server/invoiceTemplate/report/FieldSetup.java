...
public class FieldSetup {
    ...
    public JRDesignExpression createExpression(TableLines cl, String formatter) {
        ...
        if (Number.class.isAssignableFrom(type)) {
            if (UL_MONEY.equals(formatter)) {
                ...
                exp.setText("(new java.text.DecimalFormat(\"" + formatter.replace($_CS, "\" + $P{currency_symbol} + \"") + "\").format(" + expr + "))");
            }
