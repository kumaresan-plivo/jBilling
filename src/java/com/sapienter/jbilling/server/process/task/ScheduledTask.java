...
public abstract class ScheduledTask extends PluggableTask implements IScheduledTask {
    ...
    public void execute (JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            if(executionDate == null) executionDate = new Date();
            ...
            LOG.error("Error while executing batch job", t);
            if(useTransaction) {
    ...
    public void executeOn(Date date) throws SchedulerException, PluggableTaskException{
        ...
        Scheduler scheduler = JobScheduler.getInstance().getScheduler();

        scheduler.getContext().put(EXECUTION_DATE_PARAMETER, date);
