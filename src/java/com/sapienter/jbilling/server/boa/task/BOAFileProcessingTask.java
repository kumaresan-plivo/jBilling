...
public class BOAFileProcessingTask extends AbstractCronTask {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        if (!Util.getSysPropBooleanTrue(Constants.PROPERTY_RUN_API_ONLY_BUT_NO_BATCH) && Util.getSysPropBooleanTrue(Constants.PROPERTY_RUN_BOA_FILE_JOB)) {
            ...
            paramBuilder.addDate("time", new Date());
