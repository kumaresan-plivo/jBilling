 ...
 */
public class OrderChangeBasedCompositionTask extends PluggableTask implements InvoiceCompositionTask {
    ...
    public void apply (NewInvoiceContext invoiceCtx, Integer userId) throws TaskException {
        ...
        for (NewInvoiceContext.OrderContext orderCtx : invoiceCtx.getOrders()) {
            ...
            for (OrderLineDTO orderLine : order.getLines()) {
                ...
                List<NewInvoiceContext.OrderLineCtx> contexts = NewInvoiceContext.calcOrderLineChanges(orderLine, invoiceCtx.getBillingDate());
