...
public class NewInvoiceContext extends InvoiceDTO {
    ...
    public static class OrderLineCtx extends OrderLineDTO {
        ...
        private static List<OrderLineCtx> fromOrderCharges (OrderLineDTO orderLine, Date billingDate) {
        ...
        private static List<OrderChangeCtx> recalcOrderChanges (OrderLineDTO orderLine, Date billingDate) {
            ...
            Date lastBillingDate = cal.getTime();
            ...
            for (OrderChangeDTO changeDTO : sourceChanges) {
                if (!com.sapienter.jbilling.common.Util.truncateDate(changeDTO.getStartDate()).after(
                        com.sapienter.jbilling.common.Util.truncateDate(lastBillingDate))){
    ...
    public static List<OrderLineCtx> calcOrderLineChanges (OrderLineDTO orderLine, Date billingDate) {
