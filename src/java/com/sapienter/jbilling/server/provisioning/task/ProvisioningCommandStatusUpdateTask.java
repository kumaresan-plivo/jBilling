...
public class ProvisioningCommandStatusUpdateTask extends PluggableTask implements IInternalEventsTask {
    ...
    protected void doProcessEvent(ProvisioningCommandDTO command) throws PluggableTaskException {
        ...
        switch (command.getCommandType()) {
            case ORDER:
                ...
                OrderProvisioningCommandDTO orderProvisioningCommand = (OrderProvisioningCommandDTO)command;
                processOrderProvisioningCommandUpdate(orderProvisioningCommand);
                break;

            case ORDER_LINE:

                OrderLineProvisioningCommandDTO orderLineProvisioningCommand = (OrderLineProvisioningCommandDTO)command;
                processOrderLineProvisioningCommandUpdate(orderLineProvisioningCommand);
                break;

            case ASSET:

                AssetProvisioningCommandDTO assetProvisioningCommand = (AssetProvisioningCommandDTO)command;
                processAssetProvisioningCommandUpdate(assetProvisioningCommand);
                break;

            case PAYMENT:

                PaymentProvisioningCommandDTO paymentProvisioningCommand = (PaymentProvisioningCommandDTO)command;
    ...
    protected void processPaymentProvisioningCommandUpdate(PaymentProvisioningCommandDTO paymentProvisioningCommand) {
    ...
    protected void processAssetProvisioningCommandUpdate(AssetProvisioningCommandDTO assetProvisioningCommand) {
    ...
    protected void processOrderLineProvisioningCommandUpdate(OrderLineProvisioningCommandDTO orderLineProvisioningCommand) {
    ...
    protected void processOrderProvisioningCommandUpdate(OrderProvisioningCommandDTO orderProvisioningCommand) {
