...
public class FileConstants {
    ...
    public static final String EDI_TYPE_FORMAT_PATH = "edi"+File.separator+"format";
    ...
    public static final String CUSTOMER_INFORMATION_AIT = "Customer Information";
    public static final String BUSINESS_INFORMATION_AIT = "Business Information";
    ...
    public static final String COMMUNICATION_OUTBOUND_PATH = Util.getSysProp("base_dir").replace(RESOURCES_PATH, "") + File.separator + "ediCommunication" + File.separator + OUTBOUND_PATH;
    public static final String COMMUNICATION_INBOUND_PATH = Util.getSysProp("base_dir").replace(RESOURCES_PATH, "") + "ediCommunication" + File.separator + INBOUND_PATH;

    public static String getEDITypePath(Integer entityId, String ediPath, String transactionTpe) {
        return Util.getSysProp("base_dir").replace(RESOURCES_PATH, "") + File.separator + FileConstants.EDI_TYPE_PATH + File.separator + entityId + File.separator + ediPath + File.separator + transactionTpe;
    }

    public static String getFormatFilePath() {
        return Util.getSysProp("base_dir").replace(RESOURCES_PATH, "") + File.separator + FileConstants.EDI_TYPE_FORMAT_PATH;
    }
...
//    Company Level Metafield
    ...
    public static final String CUSTOMER_LAST_ENROLLMENT_METAFIELD_NAME="LAST_ENROLLMENT";
