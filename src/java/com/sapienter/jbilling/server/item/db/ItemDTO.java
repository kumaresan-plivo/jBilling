...
public class ItemDTO extends AbstractDescription implements MetaContent, Exportable, Auditable {
    ...
    private Set<UsagePoolDTO> itemUsagePools = new HashSet<UsagePoolDTO>();
    ...
    public SortedMap<Date, PriceModelWS> getPricesForSelectedEntity(Integer entityId) {
		...
		SortedMap<Date, PriceModelDTO> prices= null; 
		if(entityId != null) {
    ...
    public PriceModelDTO getPrice(Date today, Integer entityId) {
    	...
    	if (specific != null) {
            ...
            return PriceModelBL.getDTO(new PriceModelWS(PriceModelStrategy.ZERO.name(), BigDecimal.ZERO, null));
        }
    }
    ...
    public Object[][] getFieldValues() {
        ...
        PriceModelDTO currentPrice = getPrice(new Date(), null);
