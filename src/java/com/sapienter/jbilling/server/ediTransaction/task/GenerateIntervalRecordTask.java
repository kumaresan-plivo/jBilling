...
public class GenerateIntervalRecordTask extends PluggableTask
    ...
    public enum IntervalRecordConstant{
        ...
        INTERVAL_USAGE_REQUIRED_METAFIELD("Interval Usage Required"),
        ...
        try{
           ...
           //Validating customer : if customer not exist in the system then return
            ...
            try{
                ...
                userDTO = ediTransactionBean.findUserByAccountNumber(getEntityId(), FileConstants.CUSTOMER_ACCOUNT_KEY, customerAccountNumber);
            ...
            MetaFieldValue intervalUsageMetaField=planDTO.getMetaField(IntervalRecordConstant.INTERVAL_USAGE_REQUIRED_METAFIELD.getValue());
