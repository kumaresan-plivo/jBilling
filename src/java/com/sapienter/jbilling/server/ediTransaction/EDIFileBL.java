...
//        dto.setVersionNum(ws.getVersionNum());
    ...
    public EDIFileRecordDTO getEDIFileRecordDTO(EDIFileRecordWS ediFileRecordWS) {
        ...
        ediFileRecordDTO.setCreationTime(new Date());
    ...
    public EDIFileWS createEDIFileWS(String fileName, EDITypeDTO ediTypeDTO, CompanyDTO company, TransactionType transactionType, EDIFileStatusDTO fileStatusDTO) {
        ...
        ediFileWS.setCreateDatetime(new Date());
    ...
    // Note: this method is uesd when we update the edi file  status of edi file manually
    public int updateStatus(EDIFileWS ediFileWS, EDIFileStatusWS statusWS) {
        ...
        UpdateEDIFileStatusEvent event=new UpdateEDIFileStatusEvent(fileDTO.getEntity().getId(), fileDTO, ediFileWS.getEdiFileStatusWS().getName());
        EventManager.process(event);
