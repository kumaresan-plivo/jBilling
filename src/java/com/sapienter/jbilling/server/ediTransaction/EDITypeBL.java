...
//        Validate edi type here.
        ...
        if ((ediTypeWS.getId() == null || ediTypeWS.getId() == 0) && ediFormatFile == null) {
            throw new SessionInternalError("Please upload a EDI type format file.", new String[]{"edit.type.upload.file"});
        }
