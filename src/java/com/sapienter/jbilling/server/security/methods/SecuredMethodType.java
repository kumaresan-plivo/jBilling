...
public enum SecuredMethodType {
        ...
        ITEM {
            public WSSecured getMappedSecuredWS(Serializable id) {
                ...
                if ( CollectionUtils.isNotEmpty(item.getPlans()) || item.getEntities().size() == 1 ) {
        ...
        ASSET {
            public WSSecured getMappedSecuredWS(Serializable id) {
	            ...
	            return (null!=asset && asset.getId()!=0)  ? new MappedSecuredWS(asset.getEntity().getId(), null) : null;
            }
        },
