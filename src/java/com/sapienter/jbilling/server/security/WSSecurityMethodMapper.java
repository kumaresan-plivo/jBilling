...
public class WSSecurityMethodMapper {
    ...
    static {
        ...
        SecuredMethodFactory.add("getLastPaymentsPage", 0, SecuredMethodType.PAYMENT);
        ...
        SecuredMethodFactory.add("getAllItemCategoriesByEntityId", 0, SecuredMethodType.ITEM);
