...
final public class DiameterResultWS implements Serializable {
    ...
    final private BigDecimal grantedUnits;
    final private boolean terminateWhenConsumed;
    final private int quotaThreshold;
