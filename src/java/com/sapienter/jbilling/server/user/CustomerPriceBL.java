...
public class CustomerPriceBL {
    ...
    public void expirePrices(Integer planId, Date priceExpiryDate) {
        ...
        LOG.debug("Expired %s customer price entries for plan %s effective from %s", deleted, planId, priceExpiryDate);
    }
    ...
    public void updatePriceSubscriptionDate(Integer planId, Date newSubscriptionDate) {
        ...
        LOG.debug("Refreshed %s customer price entries for plan %s effective from %s", deleted, planId, newSubscriptionDate);
    }
    ...
    public void removePrices(List<PlanItemDTO> planItems) {
        ...
        LOG.debug("Removed %s customer price entries for plan items.", deleted, planItems.size());
    }
    ...
    public void removePrice(PlanItemDTO planItem) {
        ...
        LOG.debug("Removed %s customer price entries for plan item: %s", deleted, planItem);
    }
     ...
     */
    public PlanItemDTO getPrice(Integer itemId, Boolean planPricingOnly) {
        return customerPriceDas.findPriceByItem(userId, itemId, planPricingOnly, null);
    }
     ...
     * @return customer price, null if no special price found
     */
    public PlanItemDTO getPriceForDate(Integer itemId, Boolean planPricingOnly, Date pricingDate) {
        return customerPriceDas.findPriceByItem(userId, itemId, planPricingOnly, pricingDate);
    }
    ...
    public List<PlanItemDTO> getCustomerPrices(Integer itemId) {
        return getCustomerPrices(itemId, null);
    }
     ...
     * @return list of prices, empty list if none
     */
    public List<PlanItemDTO> getCustomerPrices(Integer itemId, Boolean planPricingOnly) {
        return customerPriceDas.findAllCustomerPricesByItem(userId, planPricingOnly, itemId);
    }
     ...
     */
    public List<PlanItemDTO> getPricesByAttributes(Integer itemId, Map<String, String> attributes, Boolean planPricingOnly, Date pricingDate) {
        return customerPriceDas.findPriceByAttributes(userId, itemId, attributes, planPricingOnly, null, pricingDate);
    }
     ...
     * @return list of found customer prices, empty list if none found.
     */
    public List<PlanItemDTO> getPricesByAttributes(Integer itemId, Map<String, String> attributes, Boolean planPricingOnly, Integer maxResults, Date pricingDate) {
        return customerPriceDas.findPriceByAttributes(userId, itemId, attributes, planPricingOnly, maxResults, pricingDate);
    }
     ...
     * @return list of found customer prices, empty list if none found.
     */
    public List<PlanItemDTO> getPricesByWildcardAttributes(Integer itemId, Map<String, String> attributes, Boolean planPricingOnly, Date pricingDate) {
        return customerPriceDas.findPriceByWildcardAttributes(userId, itemId, attributes, planPricingOnly, null, pricingDate);
    }
     ...
     * @return list of found customer prices, empty list if none found.
     */
    public List<PlanItemDTO> getPricesByWildcardAttributes(Integer itemId, Map<String, String> attributes, Boolean planPricingOnly, Integer maxResults, Date pricingDate) {
        return customerPriceDas.findPriceByWildcardAttributes(userId, itemId, attributes, planPricingOnly, maxResults, pricingDate);
    }
     ...
     * @return customer price, null if no special price found
     */
    public List<PlanItemDTO> getAllCustomerPricesForDate(Integer itemId, Boolean planPricingOnly, Date pricingDate) {
        return customerPriceDas.findPricesByItemAndDate(userId, itemId, planPricingOnly, pricingDate);
    }
