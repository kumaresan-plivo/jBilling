...
public class CustomerPriceDAS extends AbstractDAS<CustomerPriceDTO> {
     ...
     */
    public PlanItemDTO findPriceByItem(Integer userId, Integer itemId, Boolean planPricingOnly, Date pricingDate) {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<PlanItemDTO> findAllCustomerPricesByItem(Integer userId, Boolean planPricingOnly, Integer itemId) {
    ...
    public int updatePriceSubscriptionDate(Integer userId, Integer planId, Date newSubscriptionDate) {
        ...
        query.setParameter("new_active_date", Util.truncateDate(new Date()));
        query.setParameter("plan_id", planId);
        query.setParameter("user_id", userId);
