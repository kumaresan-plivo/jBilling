...
public class MatchingFieldWS implements WSSecured, Serializable {
	...
	public String toString() {
		return String
				.format("MatchingFieldWS [id=%s, orderSequence=%s, required=%s, description=%s, mediationField=%s, matchingField=%s, type=%s, routeId=%s, routeRateCardId=%s, entityId=%s, longestValue=%s, mandatoryFieldsQuery=%s]",
						id, orderSequence, required, description,
