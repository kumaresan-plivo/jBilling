...
public class RouteBL {
    private static final FormatLogger LOG = new FormatLogger(Logger.getLogger(RouteBL.class));
    ...
    private JdbcTemplate memcacheJdbcTemplate;
    ...
    public Integer create(RouteDTO routeDTO, File routeFile) {
        ...
        if (routeDTO != null) {
            LOG.debug("Saving new rate card " + routeDTO);
    ...
    public void saveRoutes(File routesFile) throws IOException, SQLException {
        ...
        LOG.debug("Created table '" + routeDTO.getTableName() + "'");
    ...
    public void update(RouteDTO routeDTO, File routeRatesFile) {
        ...
        if (this.routeDTO != null) {
            ...
            LOG.debug("Re-creating the route table & saving updated routes");
            if (routeDTO != null && routeRatesFile!=null) {
                dropRoutes();
            ...
            LOG.debug("Saving updates to route " + routeDTO.getId());
            ...
            if (alterTableSql != null) {
                LOG.debug("Renaming the route table");
            ...
            LOG.error("Cannot update, RouteDTO not found or not set!");
        }
    }
    ...
    public void dropRoutes() {
        ...
        LOG.debug("Dropped table '" + routeDTO.getTableName() + "'");
    }
    ...
    public void registerSpringBeans(boolean finderOnly) {
        ...
        if (finderOnly) {
            ...
            LOG.info("Registering beans: " + readerBeanName + ", " + loaderBeanName + ", " + finderBeanName + ", " + updaterBeanName + ", " + tableDefBeanName);
    ...
    public void removeSpringBeans(boolean finderOnly) {
        ...
        try {
            ...
            if (!finderOnly) {
                ...
                LOG.info("Removing beans: " + readerBeanName + ", " + loaderBeanName + ", " + finderBeanName + ", " + tableDefBeanName + ", " + updaterBeanName);
    ...
    public void delete() {
        ...
        if (routeDTO != null) {
            ...
            LOG.error("Cannot delete, RouteDTO not found or not set!");
        }
    }
    ...
    public MatchingFieldWS convertMatchingFieldDTOToMatchingFieldWS(MatchingFieldDTO matchingFieldDTO){
        ...
        matchingFieldWS.setLongestValue(matchingFieldDTO.getLongestValue());
