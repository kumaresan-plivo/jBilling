...
public class RouteRateCardDTO implements Route {
    ...
    public static final List<String> TABLE_COLUMNS_NAMES = Arrays.asList(new String[]{"id","name","surcharge","initial_increment","subsequent_increment","charge"});
    ...
    // transient
    private Set<RouteRateCardRecord> routeRateCardRecords = new HashSet<RouteRateCardRecord>(0);
