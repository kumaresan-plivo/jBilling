...
public class VerifyThatUserIsAbleToCreateYearlyPrepaidOrder extends BrowserApp {
	...
	public void VerifyUserAbleToCreateMonthlyPostpaidOrder() throws Exception {
		...
		String planName = this.plansPage.addPlanYearly(AddPlanField.BUNDLEDPERIOD, categoryName, description2, "yearlyPrePaid", "ypp",
				orderPeriod);
		...
		this.customerPage = this.customerPage.createOrderYearly("createOrderYearlyPrepaid", "coyp", planName);
