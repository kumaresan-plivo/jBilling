...
public class PlansProductPricingTest {
    ...
    //TODO This test is giving wrong results, maybe there is some bug.
    @Test(description = "Test company pooled pricing strategy", enabled = false)
    public void test005CompanyPooledPricingStrategy() {
        ...
        testBuilder.given(envBuilder -> {
            ...
            productIds[3] = plansHelper.buildAndPersistFlatProduct("Plan", false, categoryIds[0], new BigDecimal("10"), api, envBuilder);
            ...
            assertEquals(orderChild2.getTotalAsDecimal()
                                 .setScale(BigDecimal.ROUND_CEILING, 2), new BigDecimal("300").setScale(BigDecimal.ROUND_CEILING, 2), "Expected total value should be 300"); //it returns 301
        });
    }
    ...
    private void addMetafield (String metafieldNameCcCardholderName, boolean disabled, boolean mandatory,
        ...
        metaFieldValue.setDataType(string);
    ...
    private TestBuilder initTestDataForPayment (String code, String userName) {
        return testBuilder.given(envBuilder -> {
            ...
            addMetafield(Constants.METAFIELD_NAME_CC_CARDHOLDER_NAME, false, true, DataType.STRING, 1, "Ashish", metaFields);
            addMetafield(Constants.METAFIELD_NAME_CC_NUMBER, false, true, DataType.INTEGER, 2, "4111111111111152", metaFields);
            addMetafield(Constants.METAFIELD_NAME_CC_EXPIRY_DATE, false, true, DataType.DATE, 3, DateTimeFormat.forPattern(Constants.CC_DATE_FORMAT)
                    .print(expiryDate.getTime()), metaFields);
