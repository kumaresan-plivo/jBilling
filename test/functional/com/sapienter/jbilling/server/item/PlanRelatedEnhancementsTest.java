 ...
 */
@Test(groups = {"rating-late-usage", "plan-enhancements"})
public class PlanRelatedEnhancementsTest {
    ...
    public void priceDeterminationTest() {
        ...
        System.out.println("TEST OUT: PlanRelatedEnhancementsTest.priceDeterminationTest");
        ...
        System.out.println("TEST OUT: Created Account Type Price as " + price);
        ...
        System.out.println("TEST OUT: Created Customer Price as " + customerPrice);
    ...
    public void planUpdate() {
        ...
        System.out.println("TEST OUT: PlanRelatedEnhancementsTest.planUpdate");
        ...
        api.updatePlan(plan);
        watch.stop();
        System.out.println("TEST OUT: Total time taken for updating plan having " + LOOP_UNTIL + " subscriptions is " + watch.getTotalTimeMillis());
        ...
        for (Integer orderId : orderIds) {
            System.out.println("TEST OUT: Deleting Parent Order " + orderId + "and its child " + (orderId - 1));
        ...
        System.out.println("TEST OUT: Total time taken for re-subscription is " + watch.getTotalTimeMillis());

        // Delete Created Users. All orders associated would also get deleted.
        for (Integer userId : userIds) {
            System.out.println("TEST OUT: Deleting User:" + userId);
            api.deleteUser(userId);
        }
       /* api.deletePlan(plan.getId());*/
    }
    ...
    public PlanWS addPlanItems(PlanWS plan) {
        System.out.println("TEST OUT: PlanRelatedEnhancementsTest.addPlanItems");
