...
@Test(groups = { "web-services", "route-rate-cards" })
public class WSTest {
	...
	public void getAPI() throws Exception {
        ...
        if (null == accountTypes || accountTypes.length == 0) {
            ...
            System.out.println("New Account Type ID " + newAccountTypeId);
	...
	public void test001RateCardHiearachy() {
		System.out.println("test001RateCardHierarchy");
		System.out.println("Test Hierarchical Route Based Rate Card");
		...
		try {
			...
			System.out.println("Created Item Type " + itemTypeId);
			...
			System.out.println("Created User ID " + TEST_USER_ID) ;
			...
			System.out.println("Create item " + RATE_CALL_PRODUCT_ID);
            ...
            System.out.println("Created Plan with rate card , id " + plan.getId());
            ...
            System.out.println("Created Account Type Price" + rateCardProd.getId());
            ...
            assertNotNull (rateCardProd);
			System.out.println("Created Customer Price" + rateCardProd.getId());
	        ...
	        */
	        ...
	        System.out.println("Order Amount: " + order.getOrderLines()[0].getAmountAsDecimal());
	        System.out.println("Rate : " + order.getOrderLines()[0].getPrice());
	...
	public void test002RateCardFallBackToRouteIDForPricing() {
		System.out.println("test001RateCardFallBackToRouteIDForPricing");
		System.out.println("Test Fall back to RouteID. Use Route ID to resolve the rate.");
		...
		try {
			 ...
			 */
			System.out.println("Deleting configured matching fields for the Product 's configured rate cards." + RATE_CALL_PRODUCT_ID);
			for (int i=10 ; i < 14 ; i++ ) {
				api.deleteMatchingField(i);
			}

			System.out.println("The rate cards have no matching field now, will use an existing route for testing");
/*
...
*/
	         ...
	         */
			System.out.println("New Order");
            System.out.println("Test active(event) date filter");
	         ...
	         * 5,F6,CANON,1/1/2012,,0,30,10,0.5,613299
	         */
            System.out.println("Test non-unique for failure.");
            System.out.println("New Order");
    ...
    public void test003RatingUnitTest() throws Exception {
        ...
        try {
            ...
            Integer timeRatingUnitId = 1; // default rating unit for the company Pricing Pony test data
            ...
            routeRateCardWS.setRatingUnitId(timeRatingUnitId);
