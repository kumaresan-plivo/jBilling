...
public class RateOrderDiscountTest extends BaseDiscountApiTest {
    ...
    protected void setUp() {
        ...
        this.planQuantityTestCustomer = CreateObjectUtil.createCustomer(
		        CURRENCY_USD, "testPlanQuantityRateOrderApi103."+random, "newPa$$word1",
		        LANGUAGE_US, CUSTOMER_MAIN_ROLE, false, CUSTOMER_ACTIVE, null,
          		CreateObjectUtil.createCustomerContact("test@gmail.com"));
	...
	public void testRateOrderApiWithPlanBundleItems() {
		...
		System.out.println("========= testRateOrderApiWithPlanBundleItems");
        ...
        for (OrderLineWS lineWs : this.order.getPlanBundledItems()) {
        	System.out.println("======= 1.1 List Price: " + lineWs.getAmount());
        	System.out.println("======= 1.2 Adjusted Price: " + lineWs.getAdjustedPrice());
        	System.out.println("======= 1.3 Line Price: " + lineWs.getPrice());
	...
	public void testRateOrderApiWithDiscountedPlanBundleItems() {
		...
		System.out.println("========= testRateOrderApiWithDiscountedPlanBundleItems");
        ...
        for (OrderLineWS lineWs : this.order.getPlanBundledItems()) {
        	System.out.println("======= 2.1 List Price: " + lineWs.getAmount());
        	System.out.println("======= 2.2 Adjusted Price: " + lineWs.getAdjustedPrice());
        	System.out.println("======= 2.3 Line Price: " + lineWs.getPrice());
        }
	...
	public void testRateOrderApiWithPlanQuantityOnPlanBundleItems() {
		...
		System.out.println("========= testRateOrderApiWithPlanQuantityOnPlanBundleItems");
        ...
        for (OrderLineWS lineWs : this.planQuantityTestOrder.getPlanBundledItems()) {
        	System.out.println("======= 3.1 List Price: " + lineWs.getAmount());
        	System.out.println("======= 3.2 Adjusted Price: " + lineWs.getAdjustedPrice());
        	System.out.println("======= 3.3 Line Price: " + lineWs.getPrice());
            // adjusted price should be null on planBundledItems as there is no discount.
            assertNull("Adjusted Price should be null as there is no discount.", lineWs.getAdjustedPriceAsDecimal());
        }
	...
	public void testRateOrderApiWithPlanQuantityOnDiscountedPlanBundleItems() {
		...
		System.out.println("========= testRateOrderApiWithPlanQuantityOnDiscountedPlanBundleItems");
        ...
        for (OrderLineWS lineWs : this.planQuantityTestOrder.getPlanBundledItems()) {
        	System.out.println("======= 4.1 List Price: " + lineWs.getAmount());
        	System.out.println("======= 4.2 Adjusted Price: " + lineWs.getAdjustedPrice());
        	System.out.println("======= 4.3 Line Price: " + lineWs.getPrice());
        }
