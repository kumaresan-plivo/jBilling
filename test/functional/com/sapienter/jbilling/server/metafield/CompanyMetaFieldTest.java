...
@Test(groups = {"web-services", "company-metafield"}, sequential = true)
public class CompanyMetaFieldTest extends ApiTestCase {
    ...
    public void setup() throws IOException, JbillingAPIException {
        if (null == api) {
            System.out.println("Inside setup api value null");
    ...
    public void test003UpdateCompanyLevelMetaField() {
        ...
        metaFieldValueWS.setDataType(metafieldWS.getDataType());
