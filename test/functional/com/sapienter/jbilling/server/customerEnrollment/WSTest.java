...
@Test(groups = {  "web-services", "customer-enrollment" })
public class WSTest {
    ...
    public void saveAndDeleteCustomerEnrollment() throws Exception {
        ...
        fnMetaFieldValueWS.setDataType(DataType.STRING);
        ...
        ageMetaFieldValueWS.setDataType(DataType.INTEGER);
        ...
        emailMetaFieldValueWS.setDataType(DataType.STRING);
