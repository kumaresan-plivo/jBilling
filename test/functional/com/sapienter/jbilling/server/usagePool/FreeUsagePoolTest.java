...
public class FreeUsagePoolTest {
    ...
    public void test002UpdateUsagePool() {
        ...
        System.out.println("Updating usagePools");
        ...
        System.out.println("quantity"+ usagePoolsChanged.getQuantity());
        ...
        System.out.println("Restoring initial usagePool state.");
    ...
    public void test003AllUsagePools() throws Exception {
        System.out.println("#getAllUsagePools");
    ...
    public void test004CreateUsagePoolWithMultipleNames() {
        System.out.println("#testCreateUpdateDeleteUsagePools");

        UsagePoolWS usagePool= createUsagePoolWithMultipleNames();
        System.out.println("UsagePoolId created: " + usagePool.getId());
        System.out.println("UsagePoolId created: " + usagePool);
        ...
        System.out.println("names: " + enName + ", " + frName);
	...
	public void test006DeleteFreeUsagePool() {
		...
		api.deleteUsagePool(usagePoolId);
		System.out.println("UsagePool Delete Successfully.");
