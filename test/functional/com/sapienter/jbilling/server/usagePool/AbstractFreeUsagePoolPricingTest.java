...
public abstract class AbstractFreeUsagePoolPricingTest {
    ...
    public void initializeTests() {
		try {
			...
			System.out.println("Error while getting API");
		}
	...
	throws Exception {
		System.out.println("testCreateOrderForFreeUsagePool");
		final int LINES = 1;
	...
	throws Exception {
		System.out.println("testEditOrderWithoutChangeQuantityForFreeUsagePool");
		final int LINES = 1;
	...
	throws Exception {
		System.out.println("testEditOrderAndIncreaseQuantityForFreeUsagePool");
		final int LINES = 1;
	...
	throws Exception {
		System.out.println("testReducingQuantityUptoFreeUsagePool");
		final int LINES = 1;
	...
	throws Exception {
		System.out.println("testOrderLineQuantityZeroForFreeUsagePool");
		final int LINES = 1;
	...
	throws Exception {
		System.out.println("testAddNewLineWithQuantityGreaterThanFreeUsagePool");
		final int LINES = 1;
	...
	throws Exception {
		System.out.println("testAddNewLineWithQuantityEqualToFreeUsagePool");
		final int LINES = 1;
	...
	throws Exception {
		System.out.println("testAddNewLineWithQuantityLessThanFreeUsagePool");
		final int LINES = 1;
	...
	throws Exception {
		System.out.println("testCreateOrderWithTwoLinesForFreeUsagePool");
		final int LINES = 2;
	...
	throws Exception {
		System.out.println("testEditOrderAddTwoLinesForFreeUsagePool");
		final int LINES = 2;
	...
	throws Exception {
		System.out.println("testEditOrderRemoveLineWhichDoesNotUseFreeUsagePool");
		final int LINES = 2;
...
//	    rateOrderAsserts(orderWs, usagePoolId, userId, new BigDecimal(100));
	...
	throws Exception {
		System.out.println("testEditOrderLineWithFUPQuantity");
		final int LINES = 1;
	...
	throws Exception {
		System.out.println("testMultipleUsagePoolsWithMultpileOrderLines");
		final int LINES = 2;
    ...
    protected Integer createFreeUsagePool(String usagePoolName, BigDecimal quantity, Integer[] itemTypes, Integer[] items) {
        ...
        System.out.println("usagePoolId ::"+ poolId);
