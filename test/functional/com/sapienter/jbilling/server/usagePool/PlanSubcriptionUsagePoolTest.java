...
public class PlanSubcriptionUsagePoolTest {
	...
	public PlanSubcriptionUsagePoolTest() {
		System.out.println("PlanSubcriptionUsagePoolTest");
	}
	...
	public void test001UsagePoolsCreation() throws Exception {
        ...
        try {
		        ...
		        System.out.println("Creating usagePool ..." + usagePool);
	...
	public void test003CreatePlanWithMultpileUsagePools() throws Exception {
    	...
    	assertEquals(Arrays.toString(planUsagePoolsQuantity), Arrays.toString(usagePoolsQuantity));
    	assertEquals(Arrays.toString(usagePoolsId), Arrays.toString(planUsagePoolsId));
    	...
    	//Sorting
    	Collections.sort(customerUsagePools, new Comparator<CustomerUsagePoolWS>() {
	        @Override
	        public int compare(CustomerUsagePoolWS  customerUsagePool1, CustomerUsagePoolWS  customerUsagePool2) {
	        	return  customerUsagePool1.getUsagePoolId().compareTo(customerUsagePool2.getUsagePoolId());
	        }
	    });
    	i = 0;
		...
		assertEquals(Arrays.toString(customerUsagePoolsQuantity), Arrays.toString(usagePoolsQuantity));
		assertEquals(Arrays.toString(customerUsagePoolsId), Arrays.toString(planUsagePoolsId));
  ...
  //create Plan
    ...
    private UsagePoolWS createUsagePoolWithMultipleNames() {
        try {
            ...
            System.out.println("Creating Usage Pools ..." + newUsagePool);
