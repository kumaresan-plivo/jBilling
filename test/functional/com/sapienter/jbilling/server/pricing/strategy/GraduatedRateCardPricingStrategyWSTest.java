...
public class GraduatedRateCardPricingStrategyWSTest {
    ...
    public void getAPI() throws Exception {
        ...
        System.out.println("Created Customer : "+USER_ID);
    ...
    public void testGraduatedRateCardUsingRouteRateCard() {
        System.out.println("testGraduatedRateCardUsingRouteRateCard");
        ...
        */
        System.out.println("Rate : "+order.getOrderLines()[0].getAmountAsDecimal());
    ...
    public void testGraduatedRateCardUsingRoute() {
        System.out.println("testGraduatedRateCardUsingRoute");
