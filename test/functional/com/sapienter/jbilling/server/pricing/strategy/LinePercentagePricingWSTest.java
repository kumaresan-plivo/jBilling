 ...
 */
@Test(groups = {"web-services", "pricing", "linePercentage"})
public class LinePercentagePricingWSTest {
    ...
    public void test001LinePercentagePricing() {
        System.out.println("#test001LinePercentagePricing");
        OrderWS order = null;
        try {
    ...
    public void test002HistoricalPricing() {
        System.out.println("#test002HistoricalPricing");
        OrderWS order = null;
        try {
            updateItem("20.00");
            order = createOrder();
    ...
    public void test003CustomerSpecificPricing() {
        System.out.println("#test003CustomerSpecificPricing");
        OrderWS order = null;
    ...
    public void test004AccountSpecificPricing() {
        System.out.println("#test004AccountSpecificPricing");
        OrderWS order = null;
        PlanItemWS planItemWS = null;
        try {
            PlanItemWS price = new PlanItemWS();
    ...
    public void test005InvoiceTest() {
        System.out.println("#test005InvoiceTest");
        OrderWS order = null;
    ...
    public void test006PlanTest() {
        System.out.println("#test006PlanTest");
