...
public class WSTest {
    ...
    private static OrderChangePlanItemWS buildPlanChangeFromItem(ItemDTOEx item) {
...
//            assertNotNull("Order from middle of hierarchy should be retrieved", orderC);
    ...
    private static OrderWS createPlanOrder(Integer userId, Integer billingTypeId, Integer periodId, Integer... planSubscriptionIds){
    ...
    private static UserWS createUser(boolean goodCC, Integer parentId, Integer currencyId, boolean doCreate, JbillingAPI api, Integer accountTypeId) {
    ...
    private static OrderWS buildOneTimePostPaidOrder(Integer userId){
        return buildOrder(userId, Constants.ORDER_BILLING_POST_PAID, Constants.ORDER_PERIOD_ONCE);
    }

    private static OrderLineWS buildOrderLine(Integer itemId, Integer quantity, BigDecimal price, Integer... assetsId) {
        OrderLineWS line = new OrderLineWS();
        line.setTypeId(Constants.ORDER_LINE_TYPE_ITEM);
        line.setQuantity(quantity);
    ...
    private static PaymentInformationWS createCreditCard(String cardHolderName,
    ...
    private static Integer getOrCreateOrderStatusInvoice(JbillingAPI api){
