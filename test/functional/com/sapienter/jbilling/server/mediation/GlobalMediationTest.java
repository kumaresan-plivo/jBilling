...
public class GlobalMediationTest {
    ...
    public void test001ConfigurationCrud() throws Exception {
        System.out.println("test001ConfigurationCrud()");
        ...
        System.out.println("001.1 creating mediation configuration for parent");
        ...
        try {
            ...
            System.out.println("001.2 delete parent mediation config with child API call");
        ...
        System.out.println("001.3 delete parent mediation config with parent API call");
        ...
        try {
            ...
            System.out.println("001.4 create global mediation configuration with child API call");
        ...
        System.out.println("001.5 create global mediation configuration with parent API call");
        configId = parentApi.createMediationConfiguration(config);

        try {
            System.out.println("001.6 delete global mediation configuration with child API call");
            childApi.deleteMediationConfiguration(configId);
        ...
        System.out.println("001.7 delete global mediation configuration with parent API call");
        parentApi.deleteMediationConfiguration(configId);
    }

    @Test
    public void test002ConfigurationCrud() throws Exception {
        System.out.println("test002ConfigurationCrud()");
        MediationConfigurationWS config = new MediationConfigurationWS();
        config.setName("WS - Test Mediation Job");
        config.setMediationJobLauncher("sampleMediationJob");
        config.setGlobal(Boolean.FALSE);
        ...
        System.out.println("002.1 creating non global mediation configuration for parent company");
        Integer configId = parentApi.createMediationConfiguration(config);

        System.out.println("002.2 retrieve mediation configuration available to child company");
        ...
        System.out.println("002.3 delete non global mediation configuration for parent company");
        parentApi.deleteMediationConfiguration(configId);

        config.setGlobal(Boolean.TRUE);
        System.out.println("002.4 create global mediation configuration for parent company");
        configId = parentApi.createMediationConfiguration(config);

        System.out.println("002.5 retrieve mediation configuration available to child company");
        ...
        try {
            System.out.println("002.6 update global mediation configuration via child company");
        ...
        System.out.println("002.7 delete create mediation configuration for parent");
        parentApi.deleteMediationConfiguration(configId);
    }
