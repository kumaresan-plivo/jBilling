...
[![Nightly Build Status](http://ci.jbilling.com/buildStatus/icon?job=RELEASE-Telco-4.1-ant)](http://ci.jbilling.com/job/RELEASE-Telco-4.1-ant/lastCompletedBuild/testReport/)
